...
#endif
            /* CAG modification for paima, this way WebGLInput parent
               will be unity-fullscreen-container that we make fullscreen.
               The name "CanvasId" of it is somewhat bad -- it should never
               be id of <canvas>, it should be id of DOM element that owns canvas. */
            WebGLInput.CanvasId = "unity-fullscreen-container";
