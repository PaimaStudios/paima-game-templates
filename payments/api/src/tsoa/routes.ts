...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { LocationController } from './../controllers/items';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/items',
            ...
            ...(fetchMiddlewares<RequestHandler>(LocationController.prototype.get)),

            async function LocationController_get(request: ExRequest, response: ExResponse, next: any) {
